...
- ZFS will be used for the filesystem.
  ...
  - I'll also have a mirror pool on the main server for storing databases and other data that would benefit from higher bandwidth.
...
4. Boot into the installer. Select "Install" instead of "Graphical install".
5. Language: English
...
You'll need to reload your shell to refresh PATH and use bun.
