...
<MdxImage src={image2} alt="In a big bowl, beat the eggs (9)" caption />
<MdxImage src={image3} alt="Mix in the sugar (250&nbsp;g) and honey (50&nbsp;g)." caption />
<MdxImage src={image5} alt="Mix in some Grand Marnier and/or vanilla extract and/or lemon zest, molten butter (250 g), the baking powder (1 sachet), and the flour (375 g)." caption />
<MdxImage src={image6} alt="Mix until homogenized." caption />
<MdxImage src={image7} alt="Once in the oven, the madeleines start to rise and form their characteristic shape." caption />
<MdxImage src={image8} alt="Now their bump is fully formed." caption />
<MdxImage src={image9} alt="Let they cool down" caption />
<MdxImage src={image10} />
<MdxImage src={image11} alt="And here they are, with their characteristic shape and beautiful golden color!" caption />
<MdxImage src={image12} alt="They are very light and soft." caption />
<MdxImage src={image13} alt="I had a little too much of the mixture, so I made an extra one, in the shape of a cupcake." caption />
<MdxImage src={image15} />
<MdxImage src={image16} alt="It didn't rise quite as much as the others but it still tastes good." caption />
