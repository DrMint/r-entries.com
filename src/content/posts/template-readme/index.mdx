...
- **Minimal dependencies**, both for the static generation and client-side.
  - No UI framework, no CSS framework, no JS framework, no component library. **Cut the bloat!**
...
- **Respectful**
  ...
  - of user's **preferences** (light/dark mode, reduced motion, reduced data usage, etc...)
  - of user's **browser** of choice (support for all major browsers, including older versions)
