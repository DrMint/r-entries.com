...
The JPEG image is 1200 × 300 pixels.
...
- We are only providing one image size.
  If the user is on a mobile device, we are wasting bandwidth by serving a 1200 × 300 image.
...
What this means is that the image is expected to be the full width of the viewport until it reaches 1000px.
