...
- 500&nbsp;ml whole milk
- 50&nbsp;g salted butter
- 250&nbsp;g unrefined brown sugar (Cassonade)
...
Now, the baking process differs depending on whether you are using silicone molds or copper molds.

If you are using **copper molds**:

11. When the oven has reached 240&nbsp;°C, place the tray in the middle of the oven for 8 minutes.
12. After 8 minutes, without opening the oven, turn down the temperature to 180&nbsp;°C and continue baking for another 30 minutes.
13. Remove from the oven, unmold them and let them completely cool before eating. Personally I prefer waiting overnight (or at least 6 hours) before eating them so that the crust softens slightly.

If you are using **silicone molds**:
...
<MdxImage
  src={canelesCloser}
  alt="A tray of fresh Canelés, highlighting their dark golden color and shiny surface"
  caption
/>
<MdxImage
  src={canelesClosup}
  alt="A view from above of the Canelés, showing their characteristic shape"
  caption
/>
<MdxImage
  src={canelesClosupInside}
  alt="The inside of a Canelé, showing the contrast between the crusty outside and the custardy inside"
  caption
/>
