...
![A tray of fresh Canelés, highlighting their dark golden color and shiny surface](caneles-closer.png)
![A view from above of the Canelés, showing their characteristic shape](caneles-closup.png)
![The inside of a Canelé, showing the contrast between the crusty outside and the custardy inside](caneles-closup-inside.jpg)
